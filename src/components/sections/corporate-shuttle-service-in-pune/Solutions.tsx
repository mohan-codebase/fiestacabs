...
const Solutions = () => {
    const listItems = [
        {
            title: "Flexible drop services",
            desc: "Tailored to suit employee schedules for maximum convenience."
        },
        {
            title: "Optimised route planning",
            desc: "Strategic route management to navigate peak hours efficiently across Pune."
        },
        {
            title: "Custom shuttle schedules",
            desc: "Designed to enhance employee satisfaction and productivity by reducing wait times."
        }
    ];
                ...
                <div className="flex flex-col md:flex-row gap-12 lg:gap-20 items-stretch">
                    <div className="w-full md:w-[50%] md:pr-4 flex flex-col justify-center">
                        ...
                        <p className="text-[#555555] text-[16px] leading-relaxed mt-8 font-medium">
                            These solutions help businesses provide employees with a reliable, comfortable, and timely commuting experience.
                        </p>
                    </div>
