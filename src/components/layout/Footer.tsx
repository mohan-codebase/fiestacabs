...
const Footer = () => {
    return (
        <footer className="relative pt-16 pb-8 w-full bg-white border-t border-gray-100">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
                    ...
                    <div>
                        ...
                        <div className="flex space-x-4">
                            <a href="https://www.instagram.com/fiestasmartmobility/" className="bg-gray-100 text-gray-700 p-2.5 rounded-full hover:bg-[#EC2028] hover:text-white transition-colors" aria-label="Instagram">
                            ...
                            <a href="https://www.facebook.com/FiestaSmartMobility" className="bg-gray-100 text-gray-700 p-2.5 rounded-full hover:bg-[#EC2028] hover:text-white transition-colors" aria-label="Facebook">
                                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path fillRule="evenodd" d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" clipRule="evenodd" /></svg>
                            </a>
                            <a href="https://www.linkedin.com/company/fiestasmartmobility" className="bg-gray-100 text-gray-700 p-2.5 rounded-full hover:bg-[#EC2028] hover:text-white transition-colors" aria-label="LinkedIn">
                    ...
                    <div>
                        ...
                        <div className="mt-8">
                            <Button href="/reach-us" className=" bg-[#EC2028] transition-transform transform active:scale-95 w-full md:w-auto">
                                Contact Now
                            </Button>
                        </div>
                    </div>
